...
Route::group(['middleware' => ['api', 'auth:admin'], 'prefix' => 'center'], function ($router) {
    Route::post('store', '\App\Http\Controllers\Api\Admin\CenterController@store')->withoutMiddleware('auth:admin');
    ...
    Route::group(['middleware' => ['api'], 'prefix' => 'admin'], function ($router) {
        ...
        Route::post('store', 'App\Http\Controllers\Api\Admin\AdminController@register');
